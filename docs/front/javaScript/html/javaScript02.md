...
obj.foo() 转为 call 的形式就是 obj.foo.call(obj) ，所以 this 指向了 obj，输出结果是 10。

bar()转化为 call 的形式是 bar.call(undefined)，由于没有传 context，所以 this 就是 undefined。如果在浏览器中，默认的 this 就是 window 对象；在 Node.js 环境中默认的 this 就是 global 对象。所以在浏览器中运行结果为 5，在 Node.js 环境中为 undefined。
...
arr[0] 想象成 arr.0，进行转化=>arr.0.call(arr)
...
- <font color="red">箭头函数中没有自己的 this</font>
